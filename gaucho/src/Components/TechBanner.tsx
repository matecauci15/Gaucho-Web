...
//             <h1 
//               className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold font- mb-2 md:mb-4 leading-tight text-white uppercase transition-all duration-1000 transform"
//               style={{ 
//                 fontFamily: 'JetBrains Mono, monospace',
//                 opacity: opacity,
//                 transform: `translateY(${animationComplete ? '0' : '20px'}) scale(${animationComplete ? 1 : 0.95})`
...
//             </h1>
//             <p 
//               className="text-base sm:text-lg md:text-xl text-white mb-4 md:mb-6 transition-all duration-1000 delay-200"
//               style={{ 
//                 opacity: opacity,
//                 transform: `translateY(${animationComplete ? '0' : '20px'})`
//               }}
...
//             </p>
//             <div 
//               className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 transition-all duration-1000 delay-300"
//               style={{ 
//                 opacity: opacity,
//                 transform: `translateY(${animationComplete ? '0' : '20px'})`
//               }}
//             >
//               <button className="group border-2 md:border-3 border-[#80A8D6] hover:bg-[#80A8D6] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full transition-all flex items-center justify-center shadow-lg text-sm sm:text-base">
//                 <Bot className="mr-2 text-[#F2BF5D] group-hover:text-white transition-colors duration-300" size={20} />
//                 Iniciar Transformación
//               </button>
//               <button className="group border-2 md:border-3 border-[#80A8D6] hover:bg-[#80A8D6] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full transition-all flex items-center justify-center shadow-lg text-sm sm:text-base">
//                 <Code className="mr-2 text-[#F2BF5D] group-hover:text-white transition-colors duration-300" size={20} />{" "}
//                 Explorar Tecnologías
//               </button>
//             </div>
//           </div>
...
//               <div
//                 key={index}
//                 className="bg-[#1a1a1a] border-2 md:border-3 border-[#80A8D6] p-4 md:p-6 rounded-xl transform transition-all duration-300 hover:scale-105 ]"
//                 style={{ 
//                   opacity: opacity,
//                   transitionDelay: `${400 + index * 100}ms`,
//                   transform: animationComplete ? 'translateX(0)' : 'translateX(50px)'
...
//                   </div>
//                   <h3 
//                     className="text-center sm:text-left text-lg md:text-xl font-semibold text-white"
//                     style={{ fontFamily: 'JetBrains Mono, monospace' }}
//                   >
//                     {feature.title}
//                   </h3>
    ...
    <div className="relative w-full min-h-screen bg-[#2c2c2b] text-cyan-400 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 pt-20 md:pt-28 lg:pt-36 flex flex-col items-center text-center md:text-left md:items-start mb-5">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-4 md:space-y-6">
            <h1 
              className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-2 md:mb-4 leading-tight text-white uppercase transition-all duration-1000 transform  "
              style={{ 
                fontFamily: "'JetBrains Mono', monospace",
                opacity: opacity,
                transform: `translateY(${animationComplete ? '0' : '20px'}) scale(${animationComplete ? 1 : 0.95})`
            ...
            >
              <button className="group border-2 md:border-3 border-[#80A8D6] hover:bg-[#80A8D6] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full transition-all flex items-center justify-center shadow-lg text-sm md:text-sm sm:text-base uppercase"
                style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                <Bot className="mr-2 text-[#F2BF5D] group-hover:text-white transition-colors duration-300" size={22} />
                Iniciar Transformación
              </button>
              <button className="group border-2 md:border-3 border-[#80A8D6] hover:bg-[#80A8D6] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full transition-all flex items-center justify-center shadow-lg text-sm sm:text-base uppercase md:text-sm"
                style={{ fontFamily: "'JetBrains Mono', monospace" }}>
