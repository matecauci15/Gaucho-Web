...
//                 <h3
//                   className="text-xl font-bold text-[#80A8D6]"
//                   style={{
//                     fontFamily: "'JetBrains Mono, monospace",
//                   }}
//                 >
...
//               <div>
//                 <h3
//                   className="text-xl sm:text-2xl md:text-4xl font-semibold mb-2 sm:mb-4 text-[#80A8D6]"
//                   style={{
//                     fontFamily: "'JetBrains Mono, monospace",
//                   }}
//                 >
...
//               <span className="h-px w-6 sm:w-8 bg-[#80A8D6]"></span>
//               <h2 className="text-base sm:text-xl font-mono text-white mx-3 sm:mx-4">
//                 TECNOLOGÍAS
//               </h2>
//               <span className="h-px w-6 sm:w-8 bg-[#80A8D6]"></span>
//             </div>
...
//           <div className="flex justify-start sm:justify-center space-x-4 sm:space-x-6 md:space-x-8 py-2 overflow-x-auto pb-6 scrollbar-hide">
//             {[
//               "React",
//               "Node.js",
//               "TypeScript",
...
//                 <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#80A8D6]/10 border border-[#80A8D6]/30 mb-2 sm:mb-3 flex items-center justify-center">
//                   <span className="text-[#80A8D6] font-bold text-base sm:text-lg">
//                     {tech.charAt(0)}
//                   </span>
//                 </div>
